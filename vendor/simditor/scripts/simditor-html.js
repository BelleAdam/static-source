(function(root, factory) {
  ...
  HTMLButton = (function(superClass) {
    ...
    HTMLButton.prototype._init = function() {
      ...
      return this.editor.textarea.on(
        'input',
        (function(_this) {
          return function(e) {
    ...
    HTMLButton.prototype._resizeTextarea = function() {
      this._textareaPadding ||
        (this._textareaPadding = this.editor.textarea.innerHeight() - this.editor.textarea.height());
